...
export default function SettingsPage() {
  ...
  return (
    <div className="mx-auto max-w-md space-y-6">
      ...
      <h1 className="text-2xl font-display text-koala-heading">회원 정보</h1>
      ...
      <div className="koala-card p-6 space-y-4">
        ...
        <form onSubmit={saveNickname} className="space-y-3 border-t border-koala-secondary/20 pt-4">
          <h2 className="font-display text-koala-heading">닉네임</h2>
      ...
      <div className="koala-card p-6">
        <form onSubmit={savePassword} className="space-y-3">
          <h2 className="font-display text-koala-heading">비밀번호 변경</h2>
          <div>

...
const links = [
  ...
  { href: "/reflections/new", label: "감상 쓰기" },
  { href: "/chat", label: "책 이야기방" },
  { href: "/dictionary", label: "국어사전" },
];
  ...
  return (
    <header className="sticky top-0 z-50 border-b border-koala-secondary/30 bg-koala-card/90 backdrop-blur">
      <div className="mx-auto flex max-w-5xl items-center justify-between gap-4 px-4 py-3">
        <Link href="/" className="flex items-center gap-2 text-lg font-bold text-koala-primary">
